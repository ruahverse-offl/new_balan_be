...
class OrderResponse(BaseResponse):
    ...
    order_received_at: Optional[datetime] = Field(None, description="When order entered staff queue (paid)")
    order_packed_at: Optional[datetime] = Field(None, description="When staff marked order packed")
    delivery_assigned_at: Optional[datetime] = Field(None, description="When a delivery agent was assigned")
    delivered_at: Optional[datetime] = Field(None, description="When delivery marked completed")
